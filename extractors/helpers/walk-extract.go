...
func ExtSymlink(virtualFS *virtualfs.Fs, symlink, name string, mode fs.FileMode, mtime time.Time, r io.Reader) error {
	err := virtualFS.Symlink(symlink, name, mode, mtime)
	if err != nil {
